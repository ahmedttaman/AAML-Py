# -*- coding: utf-8 -*-
"""
Created on Mon Aug 19 12:44:13 2024
...
invoice = pd.read_excel(r"D:\AAML\CCC\Hospitals data\Radiologist Productivity\Invoices\April 2024 Procedures extract details by hospital.xlsx",sheet_name="Accessions")
...
roaster = pd.read_excel(r"D:\AAML\CCC\Hospitals data\Radiologist Productivity\Rota\April 2024 - Productivity (FINAL).xlsx")
